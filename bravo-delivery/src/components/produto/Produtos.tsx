...
const Produto = ({ description, name, price, reference, urlImagem }: IProduto) => {
    return (
        <button className='p-2'>
            <div className="border-4 border-solid border-yellow-900 bg-black rounded-lg w-full h-full">
                <div className="flex border justify-center p-3">
                    <img src={urlImagem} alt="Imagem Do Produto" width={250} />
                </div>
                <div className="border-t-4 border-solid border-yellow-900 text-left normal-case py-3 px-5">
